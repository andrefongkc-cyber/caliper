...
5. The AI layer uses exactly the commands and queries the UI uses. No privileged access. `caliper/ai` imports only `contracts` and `engine`; the shell hosts it (tested).
